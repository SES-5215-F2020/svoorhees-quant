...
Creative Assignment 2: Projections and distortions (due before class on September 21)
...
Assignment is to show a map of a large geogaphic area with 3 seperate map projections. 
Identify a variable, and show at least three different methods. 
...
covid_cartogram_cont <- covid_transformed %>%
  cartogram_cont("pop")
